...
## Grant Shipley Instructlab Demo

https://github.com/instructlab
How/where to install ilab?
```
ilab init
...
#Begin interactive chat session with Granite LLM
ilab chat

# Feed instructlab yaml file with q&a, and documents that contain backing data, documents that model can use
# to generate additional q&a, would typically generate more than 5 questions.
# Go back to before 27:14 and find out how to feed yaml to ilab.

# Where does ilab find taxonomies to use for generation?  Apparently, ./taxonomy/knowledge/...
ilab generate --num-instructions 5

#GH waves hands and says we would retrain with q&a generated by above command, than serve the new model.
ilab serve --model-path ./models/ggml-model-Q4_K_M.gguf


```

Link for ordering an Instructlab environment for learning purposes: https://demo.redhat.com/catalog?item=babylon-catalog-prod/rhdp.instructlab-rhel.prod&utm_source=webapp&utm_medium=share-link

Openshift AI developer Sandbox: https://developers.redhat.com/blog/2024/05/29/red-hat-developer-sandbox-your-free-openshift-ai-playground

To learn more about the InstructLab Project, visit our website at
(http://www.instructlab.org) or check out our GitHub repository at
(http://github.com/instructlab/instructlab). We'd love to hear your thoughts,
suggestions, or any other feedback that can help us improve our projects and make
